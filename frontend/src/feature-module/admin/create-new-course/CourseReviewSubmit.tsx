...
const CourseReviewSubmit = () => {
  ...
  const [checklist, setChecklist] = useState<ChecklistItem[]>([
    ...
    { step: 'Accreditation', completed: false, required: true },
    ...
    try {
      ...
      if (response.success) {
        ...
        setChecklist([
          ...
          { 
            step: 'Accreditation', 
            completed: !!(data.accreditedCreditType && data.accreditedCreditHours),
            required: true 
          },
          { 
            step: 'Pricing', 
  ...
  const handlePrevious = () => {
    navigate(`/admin/course-seo/${courseId}`);
  };
          ...
          <div className="col-md-8">
            ...
            <div className="row">
              ...
              <div className="col-sm-6">
                ...
                {/* FIX: Access accreditation correctly */}
                <div>{courseData.accreditedCreditHours} {courseData.accreditedCreditType} Credits</div>
              </div>
            </div>
          </div>
        </div>
