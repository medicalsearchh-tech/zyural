    ...
    <div className="row align-items-center row-gap-3">
        ...
        <div className="d-flex align-items-center">
          ...
          <div>
            <h5 className="mb-1 text-white d-inline-flex align-items-center">
              <Link to={all_routes.instructorDetails}>{fullName}</Link>
              <Link
      ...
      <div className="col-md-4">
        <div className="d-flex align-items-center flex-wrap gap-3 justify-content-md-end">
          <Link to={all_routes.instructorCreateNewCourse.replace(":courseId", "new")} className="btn btn-secondary rounded-pill">
            Add New Course
          </Link>
        </div>
      </div>
