...
const CourseSEO = () => {
  ...
  const handleNext = async () => {
    ...
    try {
      await saveDraft();
      navigate(`/instructor/course-review/${courseId}`);
    } catch (error) {
  ...
  const handlePrevious = () => {
    navigate(`/instructor/course-pricing/${courseId}`);
  };
                        ...
                        <div className="input-block">
                          ...
                          <div className="terms-content mt-2 p-3 border rounded bg-light">
                            ...
                            <ul className="list-unstyled mb-0">
                              ...
                              <li className="mb-0">
                                <i className="fa-solid fa-check text-success me-2"></i>
                                I understand the revenue sharing terms as displayed in my instructor settings
                              </li>
                            </ul>
                          </div>
                        </div>
