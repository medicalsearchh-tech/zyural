                        ...
                        <div className="course-content">
                          <div className="d-flex justify-content-between mb-2">
                            <div className="d-flex align-items-center">
                              <Link
                                to={`${all_routes.instructorDetails}/${course.instructor.id}`}
                          ...
                          <p className="d-flex align-items-center mb-3">
                            {renderStars(course.averageRating ? course.averageRating.toString() : '0')}
                          ...
                          <div className="mt-2">
                            <small className="text-muted">
                              {course.stats.totalLessons} lessons • {formatDuration(course.stats.totalDuration)} min • {course.level}
                            </small>
                          </div>
                        </div>
                      </div>
