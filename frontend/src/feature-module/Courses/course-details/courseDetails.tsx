...
import { courseApi, enrollmentApi  } from '../../../core/utils/api'// Adjust path as needed
  ...
  const handleEnrollment = async () => {
    ...
    try {
      ...
      if (user && user.role !== 'student') {
          toast.error('Please log in again as a student.')
          navigate(route.login);
          return
      }
              ...
              <div className="card bg-light">
                <div className="card-body d-lg-flex align-items-center">
                  ...
                  <div className="w-100 ps-lg-4">
                    ...
                    <p className="fs-14 mb-3">{course.subtitle}</p>
